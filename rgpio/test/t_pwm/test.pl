...
run_test( "21", "modify registers",
    "rgpio pwm --Cntl=0xffffffff --Stat=0xffffffff --DmaConf=0xffffffff" .
...
run_test( "22", "modify registers",
    "rgpio pwm --Cntl=0x11111111 --Stat=0x22222222 --DmaConf=0x33333333" .
...
run_test( "30", "modify field",
    "rgpio pwm -v --ClearFifo_1=1 --Ch2_GapErr_1=1 --DmaEnable_1=1",
    0,
    Stderr => q(),
);

run_test( "31", "apply reg then field",
    "rgpio pwm -v --Cntl=0xffffffff --ClearFifo_1=0 --Stat=0xffffffff --Ch1_GapErr_1=0",
    0,
    Stderr => q(),
);

run_test( "32", "bad option range",
    "rgpio pwm --Ch2_MsEnable_1=2 --DmaPanicLev_8=0x100",
    1,
    Stderr => q(
...
run_test( "40", "write fifo",
    "rgpio pwm -v --Cntl=0xffffffff --Ch2_MsEnable_1=0 --tx 0x111 0x222 0x333",
    0,
    Stderr => q(),
);
