...
The original RPi3 (Raspberry Pi 3) and earlier had only one spi0 Master.
RPi4 added four more identical units {spi3, spi4, spi5, spi6}.
All are available on the RPi 40-pin header of GPIO[27:0].
...
RPi4 adds 4 additional units similarly named  spi3, spi4, spi5, spi6.
