...
=item B<OutMsbFirst_1>      - Output MSB first.
 ...
 1= MSB first, shift out bit 31
 0= LSB first, shift out bit 0

Note B<ShiftLength_6> has an effect on data position in the word.
...
=item B<InMsbFirst_1>       - Input MSB first.
 ...
 1= MSB first, shift into bit 0
 0= LSB first, shift into bit 31
