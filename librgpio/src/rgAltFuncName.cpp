...
const char*		rgAltFuncName::AltFunc[][6] = {
 // Alt0          Alt1     Alt2   Alt3        Alt4          Alt5           bit
  ...
  { "sd0_CLK",    "sm_D14", "--", "sd1_CLK",  "arm_TRST",   "**"      }, // 22
  { "sd0_CMD",    "sm_D15", "--", "sd1_CMD",  "arm_RTCK",   "**"      }, // 23
  { "sd0_DAT0",   "sm_D16", "--", "sd1_DAT0", "arm_TDO",    "**"      }, // 24
  { "sd0_DAT1",   "sm_D17", "--", "sd1_DAT1", "arm_TCK",    "**"      }, // 25
  { "sd0_DAT2",   "--",     "--", "sd1_DAT2", "arm_TDI",    "**"      }, // 26
  { "sd0_DAT3",   "--",     "--", "sd1_DAT3", "arm_TMS",    "**"      }, // 27
